...
public class CoreWorkload extends Workload
{
	 ...
	 */
	public static final String FIELD_COUNT_PROPERTY_DEFAULT="10";  // hack
  ...
  // hack change here for now
  //public static final String HOTSPOT_DATA_FRACTION_DEFAULT = "0.01";
  ...
  public static final String HOTSPOT_OPN_FRACTION_DEFAULT = "0.8";
	...
	public void doTransactionRead(DB db)
	{
		...
		if (!readallfields)
		{
			...
			String fieldname="field"+fieldchooser.nextString();
                        ...
                        // hack by muntasir, always read field0
	...
	public void doTransactionUpdate(DB db)
	{
		...
		else
		{
		   ...
		   values = buildUpdate();
                ...
                //System.out.println("before: hack: value inserted from coreworkload: " + values + " key: " + keyname);
                //System.out.println("before rep: hack: value inserted from coreworkload: " + values2 + " key: " + keyname);
		db.update(table,keyname,values);
                //System.out.println("after:hack: value inserted from coreworkload: " + values2 + " key: " + keyname);
	}
	...
	public void doTransactionInsert(DB db)
	{
		...
		HashMap<String, ByteIterator> values = buildValues();
                ...
                values2 = (HashMap<String,ByteIterator>)values.clone();
                com.rits.cloning.Cloner cloner = new com.rits.cloning.Cloner();
                
                values2 = cloner.deepClone(values);
                
                //System.out.println("before: hack: value inserted from coreworkload: " + values + " key: " + dbkey);
                //System.out.println("before rep: hack: value inserted from coreworkload: " + values2 + " key: " + dbkey);
		db.insert(table,dbkey,values);
                //System.out.println("after: hack: value inserted from coreworkload: " + values2 + " key: " + dbkey);
	}
}
