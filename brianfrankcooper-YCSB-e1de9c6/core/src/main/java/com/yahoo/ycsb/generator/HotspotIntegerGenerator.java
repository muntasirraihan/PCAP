...
public class HotspotIntegerGenerator extends IntegerGenerator {
  ...
  IntegerGenerator zipkeychooser;
  ...
  public HotspotIntegerGenerator(int lowerBound, int upperBound, 
    ...
    zipkeychooser=new ScrambledZipfianGenerator(hotInterval);
  }
  ...
  public int nextInt() {
    ...
    if (random.nextDouble() < hotOpnFraction) {
      ...
      //value = lowerBound + random.nextInt(hotInterval); // if uniform for hot-set
      value = lowerBound + zipkeychooser.nextInt(); // if zipfian for hot-set
